<template>
  <div class="wrapper">
    <scroll :data="list" class="coming-wrapper" :pullup="true" @scrollToEnd="scrollToEnd">
      <div>
...
<style scoped>
  ...
  .coming-wrapper {position:absolute; width:100%; left:0; top:86px; bottom:88px; overflow:hidden; background:#fff;}
...
<script>
  ...
  export default {
    ...
    methods: {
      goDetail (id) {
        this.$router.push('/home/coming/' + id)
      },
      getFilm () {
